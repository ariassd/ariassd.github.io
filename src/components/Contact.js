                                    ...
                                    <Row justify="center" align="middle">
                                        ...
                                        >
                                            <div className="card-body">
                                                <form action={Data.about.formspree} id="contact-me-form" method="POST">
                                            ...
                                            <div className="card-body">
                                                ...
                                                {!Data.about.hidePhone && 
                                                    <React.Fragment>
                                                        ...
                                                        <p className="pb-2 text-muted">{Data.about.phone}</p>
                                                    </React.Fragment>
                                                }
                                                <p className="mb-0"><strong>Email</strong></p>
                                                <p><a href={'mailto:'+Data.about.email} target="_blank" data-type="mail" className="text-muted" rel="noopener noreferrer">{Data.about.email}</a></p>
                                                {!Data.about.hideCv && 
                                                    <React.Fragment>
                                                        <p className="mb-0"><strong>CV</strong></p>
                                                        <div>
                                                            <a href={Data.about.cv} className="text-muted"
