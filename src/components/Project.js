                            ...
                            <Row>
                                ...
                                <Col span={24} style={{textAlign: 'center'}}>
                                    <Row justify='center' gutter={32}>
                                        {
                                            projects.filter(project => (selectedCategory === 'All') || (selectedCategory !== 'All' && project.categories.includes(selectedCategory))).slice(0, visible).map((project, index) => (
                                                <Col
                                                    key={index}
                                                    xl={6}
                                                    lg={6}
                                                            ...
                                                            title={
                                                                <React.Fragment>
                                                                    <Row>
                                                                        ...
                                                                        <Col span={24}>
                                                                            <small style={{color: 'darkgray'}}>See Details</small>
                                                                        </Col>
                                                                    </Row>
                                                                </React.Fragment>
                                                            }
                                ...
                                {
                                    (projects.filter(project => (selectedCategory === 'All') || (selectedCategory !== 'All' && project.categories.includes(selectedCategory))).length) > visible && (
